...
train_env = DummyVecEnv([lambda: BitcoinTradingEnv(
    train_df, n_forecasts=params['n_forecasts'], confidence_interval=params['confidence_interval'])])
...
test_env = DummyVecEnv([lambda: BitcoinTradingEnv(
    test_df, n_forecasts=params['n_forecasts'], confidence_interval=params['confidence_interval'])])
